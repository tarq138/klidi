...
class House3Page extends Component{
    ...
    render(){
        const imagesP = [
            ...
            require("../../images/houses/3/p2.jpg")
        ];
        return(
            <>
                <Header/>
                        ...
                        <div className="qq">
                            <div className="qqq">
                                <AwesomeSlider>
                                    ...
                                    <div data-src={require("../../images/houses/3/m3.jpg")} />
                                </AwesomeSlider>  
                            </div>
                            <div className="qqqq">
                                <div className="detail_area col-md-12">94м<sup>2</sup></div>
                                <div className="flex-sb flex-w">
                                    ...
                                    <div className="detail_area col-md-12 m-t-100">24800 $</div>
                                    ...
                                    <TabPanel>
                                        ...
                                        <div className="outline-no" onClick={() => this.toggleP(1)} >
                                            <div style={{
                                                cursor: 'pointer',
                                                maxWidth: '100%',
                                                backgroundImage: `url(${require('../../images/houses/3/p2.jpg')})`
                                            }} className="q123" ></div>
                                        </div>
                                        {this.state.stateP &&
                                        <Lightbox
