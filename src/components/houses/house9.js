...
class House9Page extends Component{
    ...
    render(){
        const imagesP = [
            ...
            require("../../images/houses/9/p2.jpg"),
            require("../../images/houses/9/p3.jpg")
        ];
        const imagesF = [
                        ...
                        <div className="qq">
                            <div className="qqq">
                                <AwesomeSlider>
                                    ...
                                    <div data-src={require("../../images/houses/9/m3.jpg")} />
                                    <div data-src={require("../../images/houses/9/m4.jpg")} />
                                </AwesomeSlider>  
                            </div>
                            <div className="qqqq">
                                <div className="detail_area col-md-12">184м<sup>2</sup></div>
                                <div className="flex-sb flex-w">
                                    ...
                                    <div className="detail_area col-md-12 m-t-100">43000 $</div>
                                    ...
                                    <TabPanel>
                                        ...
                                        <div className="outline-no" onClick={() => this.toggleP(1)} >
                                            <div style={{
                                                cursor: 'pointer',
                                                maxWidth: '100%',
                                                backgroundImage: `url(${require('../../images/houses/9/p2.jpg')})`
                                            }} className="q123" ></div>
                                        </div>
                                        <div className="outline-no" onClick={() => this.toggleP(2)} >
                                            <div style={{
                                                cursor: 'pointer',
                                                maxWidth: '100%',
                                                backgroundImage: `url(${require('../../images/houses/9/p3.jpg')})`
                                            }} className="q123" ></div>
                                        </div>
                                        {this.state.stateP &&
                                        <Lightbox
